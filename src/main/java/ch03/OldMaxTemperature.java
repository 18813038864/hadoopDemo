package ch03;// cc ch03.OldMaxTemperature Application to find the maximum temperature, using the old MapReduce API
...
public class OldMaxTemperature {
  ...
  public static void main(String[] args) throws IOException {
    if (args.length != 2) {
      System.err.println("Usage: ch03.OldMaxTemperature <input path> <output path>");
      System.exit(-1);
    }
